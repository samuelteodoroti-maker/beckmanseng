      ...
      <div className="container px-4 relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-6 md:gap-8 items-center">
          {PARTNERS.map((partner, idx) => (
            ...
            >
              <div className="group relative flex items-center justify-center w-full aspect-video p-4 transition-all duration-300 bg-slate-200/50 dark:bg-white/5 rounded-2xl border border-border/50">
                <img
                  src={partner.logo}
                  alt={partner.name}
