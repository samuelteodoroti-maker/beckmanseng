          ...
          <div className="space-y-8 sm:space-y-12 reveal">
            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-4">
              {[
                ...
                <div key={i} className="glass rounded-3xl px-3 py-6 sm:p-8 text-center border-accent/10 hover:border-accent/30 transition-all duration-500 group hover:shadow-soft active:scale-95 flex flex-col items-center justify-center min-h-[140px] sm:min-h-[160px]">
