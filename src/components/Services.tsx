      ...
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {items.map((it, idx) => (
            <article
              key={idx}
              className={`group relative overflow-hidden rounded-[2.5rem] glass card-ring p-8 sm:p-10 hover-lift reveal transition-all duration-500 hover:border-accent/40 hover:shadow-glow/10 flex flex-col justify-between min-h-[320px] sm:min-h-[380px] ${
                it.span ?? ""
              }`}
